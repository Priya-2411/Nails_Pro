...
namespace NailsPro.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public BookingsController(NailContext context)
        {
            _context = context;
        }
        ...
        {
            var nailContext = _context.Bookings.Include(b => b.Customer);
            return View(await nailContext.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingId,BookingDate,CustomerId,staff_id")] Booking booking)
        {
